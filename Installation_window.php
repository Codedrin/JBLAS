    ...
    <section>
        ...
        <div class="container " style="padding: 3%; text-align:center; " >
            <form method="POST" onsubmit="return validateForm()" >
                <h3 style="color:white;"><b>Window Glass Installation Service</b></h3>
                <br>
                <div class="row" > 
                <div class="col-lg-6" >
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            <a href="installation.php" type="button" class="btn btn-primary btn-rounded d-inline-block text-center" style="color:black; background-color:#F2EAD3; width:40%; height:40px; border-radius: 20px;"><b>Back</b></a>
                        </div>
            </form>
