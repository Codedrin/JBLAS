...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center">
            ...
            // Array to store counts for each service
            $serviceCounts = [];

            // Define services and corresponding image paths
            $services = [
                'Electrical' => '../Admin/img/electrical.jpg',
                'Plumbing' => '../Admin/img/plumbing.jpg',
                ...
                'Cabinet' => '../Admin/img/cabinet.jpg',
                'Security' => '../Admin/img/securityinstallation.jpg',
                'Waterpipe' => '../Admin/img/waterpipe.jpg',
                'Gardening' => '../Admin/img/gardenlandscaping.jpg',
                'Door' => '../Admin/img/doorrepair.jpg',
                'windowinstall' => '../Admin/img/windowinstall.jpg'
            ];
                ...
                <div class='col-xl-3 col-md-6 mb-4'>
                    <div class='card shadow h-100 py-2 margin'>
                        <div class='card-body text-center'>
                            ...
                            <a href='../Admin/" . strtolower(str_replace(' ', '_', $service)) . ".php' class='btn btn-sm btn-block' style='background-color: #76453B; color:white;'>$service <span class='badge bg-danger' id='pending-count'>$serviceCounts[$service]</span></a>
