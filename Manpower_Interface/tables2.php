...
$sql = "SELECT * FROM services_tbl WHERE service_type='$serviceType' AND status='onvisit'";
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <td>{$row['status']}</td>
                        <td>
                            <a href='visited.php?book_id={$row['book_id']}&email={$row['email']}&name={$row['name']}&date={$row['schedule_repair']}&issue={$row['issue']}' class='btn btn-info btn-sm me-1' style='margin-right:5px;'>Visited</a>
                        </td>
                    </tr>"; 
