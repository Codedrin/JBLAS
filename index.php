...
@media (max-width: 992px) {
  #Services {
    padding: 10%; /* Adjust padding as needed for tablets */
  }
}
...
@media (max-width: 768px) {
  #Services {
    padding: 0; /* Adjust padding as needed for mobile phones */
  }
  .imgOffer{
    display: none;
  }
...
<?php include("navbar.php") ?>  
  ...
  <!-- What we offer -->
  <section id="Services" style="background-color:white; color:black; text-align:center; padding: 10%; ">
  ...
  <section id="sectionX" style=" color:white; text-align:center; padding:5% 15%; ">
    <h4>"Discover the difference with JBLAS, your trusted partner in home transformation."</h4>
      ...
      <br><div class="gap-2 col-12 mx-auto"  ><a href="contactus.php" type="button" class="btn btn-outline-light btn-rounded" style="color:#F3BB83; background-color:none; border-width:2px; border-color:#F3BB83;  width:70%; height:50px; border-radius: 20px; font-size:22px;">Contact Us</a>
    </section>
