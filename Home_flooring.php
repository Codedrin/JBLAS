...
<head>
    ...
    <title>Flooring Renovation Service</title>
      <!-- Stylesheet -->
    ...
    <section>
        ...
        <div class="container " style="padding: 3%; text-align:center; " >
            <form method="POST" onsubmit="return validateForm()" >
                <h3 style="color:white;"><b>Flooring Renovation Service</b></h3>
                <br>
                <div class="row" > 
                <div class="col-lg-6" >
                    <img style="height: 300px; max-width:100%;" src="images/floor.png" alt="">
                </div>
                <div class="col-lg-6" >
                <div class="row">
                    <div class="col mt-3">
