...
$schedule1 = "";
$schedule2 = "";
$service = "Home Renovation/Repair";
$serviceType = "ceiling";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($_POST['name']) || empty($_POST['mobile_number']) || empty($_POST['address']) || empty($_POST['issue']) || empty($_POST['email']) || empty($_POST['schedule_homevisit']) || empty($_POST['schedule_repair'])) {
        $errors = "All fields are required. Please choose specific date.";
    }
    ...
    <section>
        ...
        <div class="container " style="padding: 3%; text-align:center; ">
            <form method="POST" onsubmit="return validateForm()" >
                <h3 style="color:white;"><b>Ceiling Repair Service</b></h3>
                <br>
                <div class="row">
                    <div class="col-lg-6">
                        <img style="height: 300px; max-width:100%;" src="images/ceiling.png" alt="">
                    </div>
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col mt-3">
                ...
                <div class="row mt-3 ">
                    <b>
                        <p style="text-align:left;color:white;">Issue/Repair Problem</p>
                    </b>
                    <div class="col">
                        <div class="mb-3 form-floating">
                            <textarea style="color:white; border-color:#F3BB83; background-color:transparent " id="text-input" name="issue" rows="5" maxlength="200" required autocomplete="off" placeholder="Type here..."></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col mb-3">
                        <a href="clientdashboard.php" type="button" class="btn btn-primary btn-rounded d-inline-block text-center" style="color:black; background-color:#F2EAD3; width:40%; height:40px; border-radius: 20px;"><b>Back</b></a>
                    </div>
            </form>
