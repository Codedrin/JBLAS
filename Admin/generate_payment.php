...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dashboard<small style = "color: #43766C">/Generate Payment</small></h1>
        ...
        <div class="card">
            <div class="card-body">
                        <form id="reportForm" action="reports.php" method="post">
                            ...
                            <label for="QR">Upload Gcash QR Code</label><br>
                            <input type="file" id="QR" name="attachment" class="form-control mb-3">
