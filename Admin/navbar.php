...
?>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar"style="background-color: #43766C";>
            ...
            <!-- Nav Item - Pages Collapse Menu dito lalagay yung list of tables sa repairs -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="../Admin/generate_payment.php">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="../Admin/reports.php" >
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">PaoLUL</span>
