...
<head>
    ...
    <title>Water Pipe Services</title>
         <!-- Stylesheet -->
    ...
    <section>
        ...
        <div class="container " style="padding: 3%; text-align:center; " >
            <form method="POST" onsubmit="return validateForm()" >
                <h3 style="color:white;"><b>Water Pipe Lining/Repairs Service</b></h3>
                <br>
                <div class="row" > 
                <div class="col-lg-6" >
                    <img style="height: 300px; max-width:100%;" src="../images/waterpipe.png" alt="">
                </div>
                <div class="col-lg-6" >
                <div class="row">
                    <div class="col mt-3">
